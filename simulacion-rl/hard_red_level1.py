...
if __name__ == "__main__":
    ...
    print("--- ⚔️ RED TEAM - ENDURECIMIENTO NIVEL 1 (Honeypots %) ⚔️ ---") # Lo cambiamos tmb jeje
    ...
    for seed in SEEDS:
        ...
        log_dir = f"logs_red_nivel1/seed_{seed}"
        model_dir = f"modelos_red_nivel1/seed_{seed}"
