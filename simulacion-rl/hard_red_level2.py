...
class RedTeamEnv(gym.Env):
    ...
    def action_masks(self):
        ...
        for objetivo in range(self.num_nodos):
            ...
            # Calculamos los índices exactos de este objetivo en el array de acciones
            ...
            # Solo puede buscar archivos si el nodo es suyo y NO ha buscado anteriormente
...
if __name__ == "__main__":
    ...
    # print("--- ⚔️ RED TEAM - ENDURECIMIENTO NIVEL 1 (Honeypots 50%) ⚔️ ---")
    print("--- ⚔️ RED TEAM - ENDURECIMIENTO NIVEL 2 (Honeypots 50% + Presión SOC) ⚔️ ---") # Lo cambiamos tmb jeje
    ...
    for seed in SEEDS:
        ...
        log_dir = f"logs_red_nivel2/seed_{seed}"
        model_dir = f"modelos_red_nivel2/seed_{seed}"
